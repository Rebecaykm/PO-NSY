        ...
        <ul class="flex items-center flex-shrink-0 space-x-4">
            ...
            <li class="flex">
                <select id="lang" onchange="location = this.value;" class="block py-1 px-2 rounded text-sm border border-gray-300 text-gray-900  focus:border-gray-500 focus:outline-none focus:shadow-outline-gray">
                    ...
                    <option value="{{ route('lang.switch', 'en') }}" {{ session('applocale') == 'en' ? 'selected' : '' }}>
                        🇬🇧 English
                    </option>
                    <option value="{{ route('lang.switch', 'es') }}" {{ session('applocale') == 'es' ? 'selected' : '' }}>
                        🇪🇸 Español
                    </option>
                    <option value="{{ route('lang.switch', 'ja') }}" {{ session('applocale') == 'ja' ? 'selected' : '' }}>
                        🇯🇵 日本語
                    </option>
                </select>
            </li>
