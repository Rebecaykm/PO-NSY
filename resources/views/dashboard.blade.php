<x-app-layout title="AprobacionVP - OC">
    <div class="container mx-auto">
        ...
        @include('partials.table_approve_po',['requestQuotes' => $requestQuotes, 'ACTION' => 'partials.action_approve_po_vp'])
        <!-- Modal View Detail-->
        @include('partials.modal_rfq_po')
        <!-- Modal de confirmación -->
        @include('partials.modal_confirm_action_po')
    </div>
</x-app-layout>
...
<script>
    $(document).ready(function() {
        ...
        function bindViewDetails() {
            $('.view-details').on('click', function() {
                ...
                // Solicitud AJAX
                $.ajax({
                    url: "{{ route('PurchaseOrder.ApprovalVP.show', ':requestQuote') }}".replace(':requestQuote', requestQuoteId),
                    type: 'GET',
    ...
    $(document).ready(function() {
        ...
        $('#confirmAction').click(function() {
            const url = "{{ route('PurchaseOrder.ApprovalVP.handleApproval', ['id' => ':id', 'action' => ':action']) }}"
