...
return [
    ...
    */
    ...
    | Esto facilita especificar una línea de lenguaje personalizada específica
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos de validación personalizada
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar
    | nuestro marcador de posición de atributos por algo más amigable
    | para el lector, como "Dirección de correo electrónico" en lugar de "email".
