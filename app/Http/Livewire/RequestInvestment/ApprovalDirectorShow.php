...
class ApprovalDirectorShow extends Component
{
    ...
    {
        return view('livewire.request-investment.approval-director-show', [
    ...
    {
        try {
            return RequestInvestment::whereIn('StatusList_id',[22,29,48])
    ...
    public function ApprovateRI(){
        $this->selectedRI->update([
            'StatusList_id' => 29,
            'ApproveDirector' => true,
            'UserApproveDirector' => Auth::user()->name,
            'DateApproveDirector' => Carbon::today()->format('Y-m-d'),
    ...
    public function RejectedRI(){
        ...
        session()->flash('message', 'Solicitud de inversión rechazada.'); 
    }
}
