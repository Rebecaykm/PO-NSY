        ...
        <div class="overflow-y-auto mx-auto relative p-4 w-full md:max-w-3xl lg:max-w-5xl xl:max-w-7xl max-w-md max-h-screen">
            ...
            <div class="relative bg-white w-full rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <?php if($selectedRQ && $selectedRQ->StatusList_id == 18): ?>
        ...
        <div class="overflow-hidden  mx-auto relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button wire:click="BuyerApprovePO" wire:loading.attr="disabled" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Si, seguro.
                    </button>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button wire:click="RejectRQ" wire:loading.attr="disabled" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Sí, seguro.
                    </button>
...
</script><?php /**PATH C:\xampp\htdocs\GESC\resources\views/livewire/purchase-order/approval-buyer-show.blade.php ENDPATH**/ ?>