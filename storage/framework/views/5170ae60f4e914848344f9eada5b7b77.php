...
<?php $component = App\View\Components\AppLayout::resolve(['title' => 'Cotización RFQ'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="container-fluid w-75 grid px-2 mx-auto">
        ...
        <?php echo $__env->make('partials.filter_rfq', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('partials.table_quote_purchasing',['requestQuotes' => $requestQuotes, 'ACTION' => 'partials.action_quote_purchasing'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Modal View Detail-->
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.quoteFiles, function(index, quoteFile) {
                            ...
                            $('#modal-quoteFiles').append('<td class="px-4 py-2 text-xs description-cell"><a href="<?php echo e(Storage::url(' + quoteFile.id + ')); ?>" target="_blank">Ir al Documento</a></td>');
...
</script><?php /**PATH C:\xampp\htdocs\GESC\resources\views/Purchasing/requestQuote/index.blade.php ENDPATH**/ ?>